...
Usuario.init({
  ...
  rol: { type: DataTypes.ENUM('admin', 'abogado', 'usuario'), allowNull: false, defaultValue: 'usuario' },
  ...
  plan: { type: DataTypes.ENUM('basico', 'pro', 'premium'), allowNull: false, defaultValue: 'premium' }
