  ...
  const servicios = [
    {
      ...
      descripcion: "Accede a una red amplia de clientes que buscan servicios legales especializados."
    },
    {
      icon: (
        <svg className="w-16 h-16 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      descripcion: "Biblioteca digital con jurisprudencia, plantillas y documentos actualizados."
    },
    {
      icon: (
        <svg className="w-16 h-16 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      descripcion: "Herramientas avanzadas para administrar tus casos y clientes eficientemente."
    },
    {
      icon: (
        <svg className="w-16 h-16 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      descripcion: "Conecta con otros profesionales para casos complejos y referencias."
    }
  ];
